  ...
  export class ArrayList<T> {
    ...
    export namespace viewmodels {
        export class CharactersViewModel {
              constructor(getResult: (result: service.models.Response<ArrayList<models.RickAndMortyCharacter>>) => void);
              getResult: (result: service.models.Response<ArrayList<models.RickAndMortyCharacter>>) => void;
              getFirstPage(): void;
